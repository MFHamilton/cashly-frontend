...
class EditIngresos extends StatefulWidget {
  const EditIngresos({super.key});

  @override
  State<EditIngresos> createState() => _EditIngresosState();
}

class _EditIngresosState extends State<EditIngresos> {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Edita una fuente de ingreso existente',
